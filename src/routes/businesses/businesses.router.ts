...
import businessesPagingHandler from "./paging/paging.handler";
import businessesPagingRoute from "./paging/paging.route";
...
const businesses = createRouter()
  .openapi(businessesPagingRoute, businessesPagingHandler)
